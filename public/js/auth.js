...
(function () {
    ...
    function drawerAuthIcon() {
        if (state.authed) {
            return '<svg class="top-bar__auth-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" ' +
    ...
    function renderAuthControls() {
        ...
        if (drawer) {
            drawer.hidden = false;
            drawer.innerHTML = drawerAuthIcon() + '<span class="top-bar__auth-item-label">' + label + '</span>';
